(function(){
  ...
  if(grid){
    if(pages.length>0){
      ...
      grid.innerHTML='<div class="text-center py-12"><div class="text-neutral-400 mb-2"><span class="material-symbols-outlined" style="font-size:64px">home_work</span></div><p class="text-neutral-600 text-lg font-medium">No properties found</p><p class="text-neutral-500 text-sm">Check back later for new listings</p></div>';
    }
  }
})();
